    ...
    public partial class ChatForm : Form
    {
        ...
        public void handleCommand(string cmd)
        {
                ...
                try
                {
                    ...
                    // обработка успешной регистрации в чате
                    if (currentCommand.Contains("setnamesuccess")) // если полученная от сервера (user) команда #setnamesuccess, то
                    {
                    ...
                    // обработка принятия входящего файла
